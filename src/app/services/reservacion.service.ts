...
export class ReservacionService {
  ...
  updateReservacion(reservacion: any): Observable<any> {
    return this.http.put(`${this.apiUrl}/updateReservacion.php/${reservacion.id}`, reservacion, { headers: this.crearHeaders() });
  }

  // Método adicional para eliminar una reservación si fuera necesario
  eliminarReservacion(id: number): Observable<any> {
    return this.http.delete(`${this.apiUrl}/eliminarReservacion.php/${id}`, { headers: this.crearHeaders() });
  }
}
